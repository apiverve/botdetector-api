...
namespace APIVerve\Botdetector;
...
/**
 * Client for the Bot Detector API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/botdetector?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/botdetector';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BotdetectorClient] {$message}\n";
        }
    }
}
