// Package botdetector provides a Go client for the Bot Detector API.
//
// For more information, visit: https://apiverve.com/marketplace/botdetector?utm_source=go&utm_medium=readme
package botdetector
...
const (
	baseURL        = "https://api.apiverve.com/v1/botdetector"
	defaultTimeout = 30 * time.Second
)

// Client is the Bot Detector API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Bot Detector API client.
...
// Execute makes a request to the Bot Detector API with typed parameters.
//
...
//   - ua (required): string - The user agent string to analyze (URL encoded) [format: url]
