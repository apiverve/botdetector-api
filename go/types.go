...
// Request contains the parameters for the Bot Detector API.
//
// Parameters:
...
// ResponseData contains the data returned by the Bot Detector API.
...
// BotData represents the bot object.
type BotData struct {
