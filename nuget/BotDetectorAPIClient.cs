...
namespace APIVerve.API.BotDetector
{
    ...
    /// <summary>
    /// Client for the BotDetector API
    /// </summary>
    public class BotDetectorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/botdetector";
        ...
        {
            { "ua", new ValidationRule { Type = "string", Required = true, Format = "url" } }
        };
        ...
        public BotDetectorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BotDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BotDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BotDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(BotDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(BotDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BotDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BotDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BotDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BotDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BotDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(BotDetectorQueryOptions options)
        {
