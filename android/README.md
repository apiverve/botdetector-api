...
```gradle
dependencies {
    implementation 'com.github.apiverve:botdetector-api:1.1.14'
}
```
...
```java
import com.apiverve.botdetector.BotDetectorAPIClient;
import com.apiverve.botdetector.APIResponse;
import com.apiverve.botdetector.APIException;

// Initialize the client
BotDetectorAPIClient client = new BotDetectorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/botdetector](https://docs.apiverve.com/ref/botdetector)
...
- **Documentation:** [https://docs.apiverve.com/ref/botdetector](https://docs.apiverve.com/ref/botdetector)
- **Issues:** [GitHub Issues](https://github.com/apiverve/botdetector-api/issues)
