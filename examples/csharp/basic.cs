    ...
    class BotDetectorExample
    {
        ...
        static async Task<JsonDocument> CallBotDetectorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;ua&quot;] &#x3D; &quot;Googlebot/2.1 (+http://www.google.com/bot.html)&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Bot Detector API...\n");

            var result = await CallBotDetectorAPI();
